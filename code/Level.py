...
from code.Enemy import Enemy, Enemy3  # Importar Enemy3
...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        if name == "Level3":  # Se for o Level 3, dobremos o tempo
            self.timeout = TIMEOUT_LEVEL * 2  # Dobrar o tempo de Level 1 e 2
        self.window = window
        self.name = name
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    if self.name == "Level3":  # No Level 3, cria apenas Enemy3
                        self.entity_list.append(EntityFactory.get_entity('Enemy3'))
                    else:  # Nos outros níveis, cria Enemy1 ou Enemy2
